![](https://www..com/nodejs-tutorial-day27-assert.htmlassets/img/logo.png)
...
Note that you have to comment `case 3` and `case 4` to see the output of `case 5` and in the same way comment `case 3` and `case 5` to see the
output of `case 4`.
