![](https://www..com/nodejs-tutorial-day10-crypto-module-symmetric-asymmetric-encryption-decryption.htmlassets/img/logo.png)
...
2. **Key Pair :** You can generate it using openSSL or any other key pair generator or you can use the ones available [here ](https://github.com//30daysofnode/tree/master/day-10-crypto-module-part-2)
...
Plain text is transfromed to an unintelligible text with the help of `key`and ` algorithm` which we can read but can not understand due to which the
...
![](https://www..com/nodejs-tutorial-day10-crypto-module-symmetric-asymmetric-encryption-decryption.htmlassets/img/encrypt-30.png)
![](https://www..com/nodejs-tutorial-day10-crypto-module-symmetric-asymmetric-encryption-decryption.htmlassets/img/decrypt-30.png)
...
1. **Encryption using`createCipher` and decryption using `createDecipher` inbuilt methods : ** Same key is used for both encryption and decryption.
    ...
    //Actual content
    var text = " for all web development languages";
...
[__GITHUB](https://github.com//30daysofnode/tree/master/day-10-crypto-
module-part-2)
