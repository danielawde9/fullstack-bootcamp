![](https://www..com/nodejs-tutorial-day28-getting-tweets-using-nodejs.htmlassets/img/logo.png)
...
6. Node.js installed
7. MySQL db installed
8. An account on Twitter

![](assets/img/day28-directory-structure.png)

![](https://www..com/nodejs-tutorial-day28-getting-tweets-using-nodejs.htmlassets/img/day28-directory-structure.png)
...
![](https://www..com/nodejs-tutorial-day28-getting-tweets-using-nodejs.htmlassets/img/day28-screen-shot-1.png)
![](https://www..com/nodejs-tutorial-day28-getting-tweets-using-nodejs.htmlassets/img/day28-screen-shot-2.png)
![](https://www..com/nodejs-tutorial-day28-getting-tweets-using-nodejs.htmlassets/img/day28-screen-shot-3.png)
...
twitter's `streaming API` , `node.js` and `socket.io` for backend; `HTML5` , `CSS3`, ` jquery` , `socket.io` and `bootstrap` for frontend;
And `MySQL` database for storage.

Clone it from Github :
[__GITHUB](https://github.com//30daysofnode/tree/master/day28-Getting-
tweets-using-node)
