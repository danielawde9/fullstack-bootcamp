...
let student = {
    name: 'Samer',
    age:20,
    subjects: ['Linear Algebra', 'Analysis of Algorithms', 'Data Structures']
}
...
```JS
document.getElementById('myList').innerHTML = list.add(newItem);
```
...
```bash
git clone https://github.com/sameer9aseer/project1.git
```
...
```
Boilerplate code is repeating a section of code many times
```