...
25. **Javascript**:
    ...
    to test it :const num[1,4,5,6,9];
...
26. **Javascript**:
    ...
    ``` javascript
     const student = {name:"Silvana", Age:"20", Subjects:["intro to web programming", "intro to marketing", "Database", "Proba"]};```
...
**Boilerplate code is a library of code that can be copied and is used as a starting point to start building web projects. It is referred to as an HTML Framework, it is the following :
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
