    ...
    <!DOCTYPE html>
      ...
      <body>
          <div class="header">
              ...
              <div class="comments">
                  <p class="commenter-name">commenter's name</p>
                  <p class="comment-date">comment date</p>
                  <p class="comment">comment itself</p>
              </div>
          </div>
...
24. **CSS**:
    ...
    ```css
        ...
        .header .comments {
            background-color: rgba(127, 255, 212, 0.691);
        }
    ```
