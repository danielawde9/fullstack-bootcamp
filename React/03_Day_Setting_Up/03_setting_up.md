...
```sh
DanielAwde9@DESKTOP-KGC1AKC MINGW64 ~/Desktop
...
```sh
DanielAwde9@DESKTOP-KGC1AKC MINGW64 ~
\$ cd Desktop/
```
...
```sh
DanielAwde9@DESKTOP-KGC1AKC MINGW64 ~/Desktop/30-days-of-react (master)
\$ npm start
```
...
Create images folder in the src folder and save an image inside. For instance let's save DanielAwde9.jpg image and let's import this image to index.js. After importing we will inject it to a JSX expression, user. See the code below.
