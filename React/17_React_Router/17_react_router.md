...
```js
DanielAwde9@DESKTOP-KGC1AKC MINGW64 ~/Desktop/30-days-of-react$ npm install react-router-dom
```
...
const challenges = [
  {
    ...
    slug: "pyhton",
    url: "https://github.com/https://https://github.com/DanielAwde9/30-Days-Of-Python.com/DanielAwde9/30-Days-Of-JavaScript/30-Days-Of-React",
    author: {
  ...
  },
  {
    ...
    slug: "javascript",
    url: "https://github.com/DanielAwde9/30-Days-Of-JavaScript",
    author: {
      firstName: "DanielAwde9",
      lastName: "Yetayeh",
    },
  },
  {
    ...
    slug: "react",
    url: "https://github.com/DanielAwde9/30-Days-Of-React",
    author: {
      firstName: "DanielAwde9",
      lastName: "Yetayeh",
    },
      ...
      <Router>
        <div className="App">
          ...
          <Prompt
            message={({ pathname }) => {
              return this.state.isLoggedIn &&
                pathname.includes("/user/DanielAwde9")
