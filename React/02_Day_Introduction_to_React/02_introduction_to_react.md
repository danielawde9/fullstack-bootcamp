...
[Live on code pen](https://codepen.io/DanielAwde9/full/QWbGWeY).
...
Now, let us put everything together and render it to the browser. [Live on code pen](https://codepen.io/DanielAwde9/full/MWwbYWg).
...
Now, lets us apply style the header part only [Live on code pen](https://codepen.io/DanielAwde9/full/ZEGBYBG).
...
Instead of style object using regular styling method is more easy than the one above. Now, let us use internal style to style all the JSX. It is also possible to use external styling method. [Live on code pen](https://codepen.io/DanielAwde9/full/QWbGwge)
...
const authorFirstName = "DanielAwde9";
...
Now, let us put everything together. Here, in the example below, the data is injected dynamically to the JSX. [Live on code pen](https://codepen.io/DanielAwde9/full/YzXWgpZ)
